...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-gin-api-postgres)

- simple HTTP API built using [Gin](https://gin-gonic.com/) framework.
- The application runs in a [web service](https://docs.stacktape.com/compute-resources/web-services/) resource and uses
  ...
  simplify the database access, this project uses [go-gin](https://pg.uptrace.dev/).
...
```bash
stacktape init --starterId gin-api-postgres
```
