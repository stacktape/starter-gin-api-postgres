...
- This project deploys a simple HTTP API built using [Gin](https://gin-gonic.com/) framework.
...
```bash
stacktape init --projectId gin-api-postgres
```
